...
- ✓ `snapshot-invalid-modality-rejected-before-ledger-write`
- ✓ `snapshot-import-rejects-forged-modality`
...
## recall outcomes measure the north star
- ✓ `recall-outcomes-start-empty`
- ✓ `recall-outcome-location-recorded`
- ✓ `recall-outcome-capture-not-counted`
- ✓ `recall-outcome-reaffirm-counted`
- ✓ `recall-outcome-ownership-kind`
- ✓ `recall-outcome-window-default-counts-all`
...
- ✓ `recall-outcomes-bykind-splits-retrieval-vs-avoided-purchase`
...
- ✓ `tool-retrieval-plan`
- ✓ `agent-exposes-no-recall-minting-verb`
- ✓ `agent-dispatch-cannot-mint-a-recall-outcome`
...
## release ends whatever placement is live at accept time
- ✓ `accept-ends-live-placement`
- ✓ `reversal-yields-no-stale-placement`
## re_home clears the flag it was offered to resolve
- ✓ `re_home-resets-lifecycle`
- ✓ `re_home-locate-not-flagged`
- ✓ `re_home-leaves-declutter`
- ✓ `re_home-clears-lent-out`
## declutter keeps the un-acted partner of a duplicate pair
- ✓ `dup-pair-baseline`
- ✓ `dup-partner-survives`
- ✓ `acted-item-suppressed`
## attention hides gone items even with an active placement
- ✓ `gone-with-active-placement-reachable`
- ✓ `attention-excludes-gone`
...
- ✓ `locate-by-id-pins-exact-belonging`
## P0.10 sync service
...
- ✓ `buttons-named-ask`
- ✓ `view-renders-recall`
- ✓ `form-controls-named-recall`
- ✓ `buttons-named-recall`
...
- ✓ `spatial-keyboard-cycles-selection`
- ✓ `spatial-inspector-has-single-live-region`
- ✓ `spatial-box-selection-names-the-box`
...
- ✓ `dom-snapshot-voice-degrades-honestly-when-api-absent`
- ✓ `dom-snapshot-photo-disclosure-states-on-device-evidence-and-removal`
- ✓ `dom-proposal-photo`
...
- ✓ `dom-reuse-pre-purchase-button-mints-distinct-outcome`
...
- ✓ `dom-released-item-not-cached-as-have`
...
- ✓ `responsive-320-no-document-overflow-recall`
- ✓ `responsive-320-critical-content-visible-recall`
...
- ✓ `responsive-390-no-document-overflow-recall`
- ✓ `responsive-390-critical-content-visible-recall`
...
- ✓ `responsive-761-no-document-overflow-recall`
- ✓ `responsive-761-critical-content-visible-recall`
...
- ✓ `own-plan-renders`
- ✓ `own-3d-inspector-shows-honest-empty-anchor-state`
- ✓ `own-room-capture-refuses-to-fabricate-a-sample`
